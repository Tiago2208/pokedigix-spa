            ...
            <div class="col-md-auto" v-for="treinador in treinadores" :key="treinador.id">
                <div class="card mb-4" style="max-width: 230px;">
                    <h5 class="card-header">
                        {{treinador.nome}}
                        <button class="btn" @click="trocar(treinador)"><svg xmlns="http://www.w3.org/2000/svg" width="16"
                                height="25" fill="blue" class="bi bi-arrow-right-square" viewBox="0 0 16 21">
