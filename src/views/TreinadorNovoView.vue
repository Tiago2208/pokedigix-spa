            ...
            <div class="col-4 mb-2" v-for="endereco in enderecos" :key="endereco.id">
                <div class="card">
                    ...
                    <div class="card-footer text-center">
                      <input type="radio" :value="endereco.id" class="form-check-input" name="radioEndereco" v-model="treinadorRequest.idEndereco"/>
                    </div>
                </div>
            </div>
            <div class="col-4">
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" @click.prevent="cancelar">Cancelar</button>
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" @click.prevent="salvarEndereco">Salvar</button>
                    </div>
                </form>
                </div>
            </div>
